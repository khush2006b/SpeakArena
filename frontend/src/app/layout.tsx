...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: "/icon-16.png?v=6", sizes: "16x16", type: "image/png" },
      { url: "/favicon.ico?v=6" },
    ],
    shortcut: ["/icon-32.png?v=6", "/icon.svg?v=6"],
    apple: [
  ...
  return (
    ...
    >
      <head>
        ...
        <link rel="icon" href="/icon-32.png?v=6" sizes="32x32" type="image/png" />
        <link rel="icon" href="/icon-16.png?v=6" sizes="16x16" type="image/png" />
