        ...
        *,
        ...
        for r in rows:
            ...
            items.append({
                ...
                "usd_price": float(c.usd_price) if getattr(c, "usd_price", None) is not None else None,
                "original_usd_price": float(c.original_usd_price) if getattr(c, "original_usd_price", None) is not None else None,
                "level": c.level,
                "language": c.language,
